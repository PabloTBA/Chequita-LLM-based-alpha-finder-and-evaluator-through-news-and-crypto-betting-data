...
//#region node_modules/vanta/dist/vanta.globe.min.js
var require_vanta_globe_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(t, e) {
		...
		function s(t, e) {
			return t ??= 0, e ??= 1, t + Math.random() * (e - t);
		}
		...
		h.VantaBase = class {
			constructor(t = {}) {
				...
				if (this.options = Object.assign({
					...
					scale: 1,
					scaleMobile: 1
				}, e), (t instanceof HTMLElement || "string" == typeof t) && (t = { el: t }), Object.assign(this.options, t), this.options.THREE && (r = this.options.THREE), this.el = this.options.el, null == this.el) a("Instance needs \"el\" param!");
				...
				try {
					...
					a("Init error", t), this.renderer && this.renderer.domElement && this.el.removeChild(this.renderer.domElement), this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = (i = this.options.backgroundColor, "number" == typeof i ? "#" + ("00000" + i.toString(16)).slice(-6) : i));
					return;
				}
		...
		class d extends l {
			...
			onInit() {
				...
				this.blending = i(new p.Color(this.options.color)) > i(new p.Color(this.options.backgroundColor)) ? "additive" : "subtractive";
				...
				const c = new p.LineBasicMaterial({ color: this.options.color2 }), d = [];
				for (let t = 0; t < 80; t++) {
